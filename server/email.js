Meteor.methods({
  ...
  sendEmail(to, from, subject) {
    ...
    if(check(to) && check(from) && check(subject)) {
      ...
      const html = `
        <table style="min-width:140px;width:60%;margin:0 auto;font-family:Verdana, sans-serif;line-height:1;table-layout:auto;background-color:white">
          <tbody>
            ...
            <tr>
              ...
              <td style="text-align:center;padding:0 10px;font-size:25px;font-weight:600;letter-spacing:1px">(306) 854-2265</td>
            </tr>
      ...
      const text = `
        ...
        Do not reply to this email. Please contact customer support at jeff@commutron.ca.
