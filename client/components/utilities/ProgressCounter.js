...
const ProgressCounter = (flow, flowAlt, batchData, expand) => {
    ...
    let regStepCounts = flowLoop(rSteps, regItems, expand, false);
    let altStepCounts = flowLoop(aSteps, altItems, expand, false);
